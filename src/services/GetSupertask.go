...
/*
	...
	Сервис предназначен для вызова только разработчиками суперзадачи.
	Если нет прав владельца, разработчика, наблюдателя или дизайнера задачи - возращает отказ доступа.
*/
