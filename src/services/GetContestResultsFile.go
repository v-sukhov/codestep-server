...
/*
	*****************************************
	Получение информации по результатам контеста в виде файла
	Доступ только для владельцев, администраторов и жюри
	Доступ по времени не ограничен (даже для жюри)
	*****************************************
*/
